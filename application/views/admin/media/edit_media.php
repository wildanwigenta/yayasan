                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= base_url('Media/update') ?>" method="post" enctype="multipart/form-data">
                                
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="id_media" id="exampleInputEmail"
                                        placeholder="media" value="<?= $media['id_media'] ?>" hidden>
                                </div>
