	...
	<div class="container py-lg-5 py-md-4 py-2">
        ...
        ?>
			<div class="col-lg-5 w3l-content-left mt-lg-4">
				...
				<div class="pl-5"><img src="<?= base_url('./assets/images/about/'.$row->gambar)?>" alt=""
						class="radius-image img-fluid" width="150px"></div>
			</div>
	...
	<div class="content-4-main py-lg-5 py-md-4">
		<div class="container">
			...
			<div class="text-center">
				<p>
					<?= wordwrap('Donasi yang telah anda berikan akan kami kumpulkan dan akan disalurkan ke beberapa',80,'<br>') ?>
					<a href="<?= base_url('Front/program') ?>">program yang kami miliki</a> </p>
			</div>
		</div>
	</div>
</section>
					...
					<div class="card-body img">
						...
						<div class="blog-des mt-4">
							...
							<h5 class="card-title mb-2"><a
									href="<?= base_url('Front/detail_berita/'.$row->id_berita) ?>"><?= $row->berita ?></a>
							</h5>
			...
			<div class="content-info-in row">
              ...
              ?>
					<div class="progress mt-3 mb-2">
						<div class="progress-bar bg-success" role="progressbar" style="width:<?=($total / 100000000) * 100 ?>%"
