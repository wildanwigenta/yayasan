      ...
      ?>
			<div class="col-lg-4 col-md-6 grids-feature mb-3">
				<div class="area-box icon-blue">
					<a href="<?= base_url('Front/detail_program/'.$row->id_program)?>"> <img
							src="<?= base_url('./assets/images/program/'.$row->gambar) ?>" style="height:210px" alt=""
							class="img-fluid radius-image"></a>
					<h4><a href="<?= base_url('Front/detail_program/'.$row->id_program)?>"
							class="title-head"><?= $row->program ?></a></h4>
				</div>
			</div>
			<?php } ?>
		</div>
