    ...
    <div class="breadcrumb-bg  w3l-inner-page-breadcrumb py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="title pt-5" style=" font-size:30px; "><?= $berita['berita'] ?></h2>
        <!-- <ul class="breadcrumbs-custom-path mt-3 text-center">
          <li><a href="<?= base_url('Front/index') ?>">Home</a></li>
          <li class="active"> <a href="<?= base_url('Front/index')?>"> </a></li>
        </ul> -->
      </div>
    </div>
        ...
        <div class="row blog-sec no-gutters">
            <div class="blog-single-post">
                ...
                <div class="single-post-image mb-5">
                    <img src="<?= base_url('./assets/images/berita/'.$berita['gambar'])?>" class="img-fluid w-100 radius-image"
                        alt="blog-post-image">
                </div>

                <div class="single-post-content">
                    <p class="mb-4"><?= $berita['deskripsi'] ?></p>
                </div>
...
<script>
    ...
    */
    ...
    s.src = 'https://dompet-lauwba.disqus.com/embed.js';
